...
class MessageAdapter(val context: Context, val messageList: ArrayList<com.example.chatapplication.model.Message>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class SendViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
       val sendMessage = itemView.findViewById<TextView>(R.id.tv_sendMessage)
    }
